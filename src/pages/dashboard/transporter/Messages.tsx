  ...
  const messages = [
    {
      ...
      preview: 'Hi, could you please provide an update on the delivery status...',
      time: '10:30 AM',
      status: 'unread',
    },
    {
      ...
      preview: 'We have a new shipment request for your route...',
      time: 'Yesterday',
      status: 'read',
    },
    {
      ...
      preview: 'Important notice regarding your scheduled route...',
      time: '2 days ago',
      status: 'read',
    },
  ];
